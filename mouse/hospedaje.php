      ...
      <div class="inicio">
        ...
        <div class="cards" id="page1">
          ...
          <div class="card" id="card1">
            <img class="card__image" src="../php/Imagen_guardar/royal.jpg" alt="">
            <div class="card__content">
              <h3>
                Collection Bogota Royal Teleport
              </h3>
              <p>
              NH Collection Bogota Royal Teleport es una magnífica elección para los viajeros que visiten Bogotá, además de numerosos servicios diseñados para mejorar tu estancia.
              </p>
            </div>
          ...
          <div class="card " id="card2">
            <img class="card__image" src="../php/Imagen_guardar/ek.jpg" alt="">
            <div class="card__content">
              <h3>
              EK Hotel
              </h3>
              <p>
              EK es un hotel que redefine lo que es un hotel de negocios. Es el destino ideal para aquellos ejecutivos que quieren estar en el centro de todo. Ejecutivos que saben de experiencias.
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card3">
            <img class="card__image" src="../php/Imagen_guardar/h.jpg" alt="">
            <div class="card__content">
              <h3>
              Hotel Estelar Parque de la 93
              </h3>
              <p>
              La búsqueda del hotel de lujo ideal en Bogotá no tiene por qué ser complicada. Bienvenido a Hotel Estelar, una fantástica opción para viajeros como tú.
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card4">
            <img class="card__image" src="../php/Imagen_guardar/lobby.jpg" alt="">
            <div class="card__content">
              <h3>
              Courtyard by Marriott Bogota Airport
              </h3>
              <p>
              Con la mejor ubicación en la avenida Calle 26, el principal objetivo del Courtyard Bogota Airport es tratar de que su estancia sea lo mejor posible.
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card5">
            <img class="card__image" src="../php/Imagen_guardar/try.jpg" alt="">
            <div class="card__content">
              <h3>
              Fairfield By Marriott Bogota Embajada
              </h3>
              <p>
              Somos apasionados por nuestros huéspedes y apasionados por la ciudad, queremos que usted se apropie de Bogotá y se sienta como en casa, nosotros sabemos como.
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card6">
            <img class="card__image" src="../php/Imagen_guardar/a.jpg" alt="">
            <div class="card__content">
              <h3>
              W Bogota
              </h3>
              <p>
              Anima tu estancia en la capital de Colombia en W de Bogota. Con una ubicación central cerca de embajadas, restaurantes y boutiques en el exclusivo vecindario de Usaquén.
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card7">
            <img class="card__image" src="../php/Imagen_guardar/exterior.jpg" alt="">
            <div class="card__content">
              <h3>
              Sofitel Bogota Victoria Regia Hotel
              </h3>
              <p>
                La excelente ubicación, elegancia, confort y servicio son la tarjeta depresentación de este Hotel francés en Bogotá.
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card8">
            <img class="card__image" src="../php/Imagen_guardar/facade.jpg" alt="">
            <div class="card__content">
              <h3>
              NH Collection Bogota Andino Royal
              </h3>
              <p>
              Si buscas un hotel para familias en Bogotá, no te pierdas NH Collection Bogota Andino Royal, Las habitaciones incluyen televisor de pantalla plana.
              </p>
