      ...
      <div class="inicio">
        ...
        <div class="cards" id="page1">
          ...
          <div class="card" id="card1">
            <img class="card__image" src="../php/Imagen_guardar/TITAN2.jpeg" alt="">
            <div class="card__content">
              <h3>
                Centro Comercial Titán Plaza
              </h3>
              <p>
                El centro comercial Titán Plaza es un centro comercial ubicado en el noroccidente de Bogotá en la localidad de Engativá.
              </p>
            </div>
          ...
          <div class="card " id="card2">
            <img class="card__image" src="../php/Imagen_guardar/plaza.jpg" alt="">
            <div class="card__content">
              <h3>
              Centro Comercial Plaza de las Américas
              </h3>
              <p>
              Amplio centro comercial con cientos de tiendas minoristas y restaurantes, además de un cine IMAX y 2 casinos.
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card3">
            <img class="card__image" src="../php/Imagen_guardar/andino.jpg" alt="">
            <div class="card__content">
              <h3>
              Centro comercial Andino
              </h3>
              <p>
              El Andino es un centro comercial de Bogotá​​ de 53.900 metros cuadrados ubicado en el barrio El Retiro, iniciado en 1991 por Pedro Gómez y Cia. y terminado en 1993.
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card4">
            <img class="card__image" src="../php/Imagen_guardar/centro.jpg" alt="">
            <div class="card__content">
              <h3>
              Centro Comercial Salitre Plaza
              </h3>
              <p>
              Salitre Plaza es un gran centro comercial en Bogotá, Colombia, conocido por sus tiendas, restaurantes y opciones de entretenimiento.
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card5">
            <img class="card__image" src="../php/Imagen_guardar/atla.jpg" alt="">
            <div class="card__content">
              <h3>
              Centro Comercial Atlantis Plaza.
              </h3>
              <p>
              Atlantis Plaza es un centro comercial ubicado en la ciudad de Bogotá, Colombia. Fue construido en 1999 e inaugurado un año más tarde. Fue diseñado por Design Group Incorporated
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card6">
            <img class="card__image" src="../php/Imagen_guardar/multi.jpg" alt="">
            <div class="card__content">
              <h3>
                Centro Comercial Multiplaza Bogota.
              </h3>
              <p>
              Ubicado dentro del mega proyecto urbanístico La Felicidad, el espacio consta de 182 000 metros cuadrados de construcción, 75 000 de ellos destinados a más de 177 tiendas
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card7">
            <img class="card__image" src="../php/Imagen_guardar/calima.jpeg" alt="">
            <div class="card__content">
              <h3>
                Centro Comercial Calima.
              </h3>
              <p>
              Se encuentra catalogado entre los Centros Comerciales más grandes y completos de Latinoamérica, contando con una infinidad de lugares para visitar
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card8">
            <img class="card__image" src="../php/Imagen_guardar/ana.png" alt="">
            <div class="card__content">
              <h3>
              Centro Comercial Santa Ana
              </h3>
              <p>
              Centro comercial luminoso con minoristas de lujo, restaurantes informales y servicios como un gimnasio y salones de belleza.
              </p>
