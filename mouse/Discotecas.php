      ...
      <div class="inicio">
        ...
        <div class="cards" id="page1">
          ...
          <div class="card" id="card1">
            <img class="card__image" src="../php/Imagen_guardar/teathorn.jpeg" alt="">
            <div class="card__content">
              <h3>
                theatron
              </h3>
              <p>
              Theatron es un famoso y grande club nocturno ubicado en Bogotá, Colombia. Se destaca por ser uno de los establecimientos de entretenimiento LGBTQ+ más grandes de América Latina
              </p>
            </div>
          ...
          <div class="card " id="card2">
            <img class="card__image" src="../php/Imagen_guardar/felina.png" alt="">
            <div class="card__content">
              <h3>
              Felina Bar
              </h3>
              <p>
                es un reconocido club nocturno ubicado en el barrio Chapinero de Bogotá, Colombia. Este establecimiento es conocido por ofrecer entretenimiento nocturno, música en vivo
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card3">
            <img class="card__image" src="../php/Imagen_guardar/paradaise.jpg" alt="">
            <div class="card__content">
              <h3>
                paradaise
              </h3>
              <p>
              paradaise discoteca tienen áreas VIP o secciones reservadas para grupos que deseen un nivel de exclusividad y servicio personalizado.
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card4">
            <img class="card__image" src="../php/Imagen_guardar/URANO.jpg" alt="">
            <div class="card__content">
              <h3>
                URANOS 
              </h3>
              <p>
              URANOS cuenta con medidas de seguridad para garantizar la seguridad de los asistentes
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card5">
            <img class="card__image" src="../php/Imagen_guardar/Bar La Santa Club.jpg" alt="">
            <div class="card__content">
              <h3>
                Bar La Santa Club
              </h3>
              <p>
              La Santa Club suele abrir en la noche y permanecer abiertas hasta altas horas de la madrugada o la madrugada.
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card6">
            <img class="card__image" src="../php/Imagen_guardar/Martina Bar.jpg" alt="">
            <div class="card__content">
              <h3>
              Martina Bar
              </h3>
              <p>
                La pista de baile es el corazón de la discoteca, donde los asistentes pueden bailar y disfrutar de la música.
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card7">
            <img class="card__image" src="../php/Imagen_guardar/El Bunker Club Bogotá.jpg" alt="">
            <div class="card__content">
              <h3>
              El Bunker Club Bogotá
              </h3>
              <p>
              En Bunker Club Bogotá suelen ofrecer una amplia variedad de música, incluyendo música electrónica, pop, hip-hop, música latina
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card8">
            <img class="card__image" src="../php/Imagen_guardar/Dubai Club.jpg" alt="">
            <div class="card__content">
              <h3>
                Dubai Club
              </h3>
              <p>
              en Dubai Club tienen códigos de vestimenta específicos que requieren que los asistentes se vistan de cierta manera
              </p>
