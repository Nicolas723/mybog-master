      ...
      <div class="inicio">
        ...
        <div class="cards" id="page1">
          ...
          <div class="card" id="card1">
            <img class="card__image" src="../php/Imagen_guardar/campin.avif" alt="">
            <div class="card__content">
              <h3>
                Estadio Nemesio Camacho El Campín
              </h3>
              <p>
                Es el estadio más emblemáticos de la ciudad. Es el hogar de los equipos Independiente Santa Fe y
                Millonarios FC.
              </p>
            </div>
          ...
          <div class="card " id="card2">
            <img class="card__image" src="../php/Imagen_guardar/techo.jpg" alt="">
            <div class="card__content">
              <h3>
                Metropolitano de Techo
              </h3>
              <p>
                Este estadio es utilizado para eventos deportivos y culturales. Sede del equipo La Equidad.
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card3">
            <img class="card__image" src="../php/Imagen_guardar/Estadio de Atletismo Pedro Grajales.jpeg" alt="">
            <div class="card__content">
              <h3>
                Estadio de Atletismo Pedro Grajales
              </h3>
              <p>
                Este estadio se encuentra en la Universidad Nacional de Colombia y es utilizado principalmente para
          ...
          <div class="card" id="card4">
            <img class="card__image" src="../php/Imagen_guardar/Estadio Hermes Barrios Cabas.jpeg" alt="">
            <div class="card__content">
              <h3>
                Estadio Hermes Barrios Cabas
              </h3>
              <p>
                Este estadio es utilizado principalmente para eventos deportivos, sirve a la comunidad de esa zona y sus
                alrededores.
              </p>
            </div>
            <div class="card__info">
          ...
          <div class="card" id="card5">
            <img class="card__image" src="../php/Imagen_guardar/unidad-deportiva-El-Salitre.jpg" alt="">
            <div class="card__content">
              <h3>
                Estadio El Salitre
              </h3>
              <p>
                Es un complejo deportivo que incluye un estadio de fútbol, piscinas, canchas de tenis y otros espacios
                para la práctica de diferentes deportes.
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card6">
            <img class="card__image" src="../php/Imagen_guardar/oEstadio de Hockey Luis Carlos Galán.....jpg" alt="">
            <div class="card__content">
              <h3>
                Estadio de Hockey Luis Carlos Galán
              </h3>
              <p>
                Como su nombre lo indica, este estadio es utilizado para la práctica de hockey sobre césped.
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card7">
            <img class="card__image" src="../php/Imagen_guardar/Estadio de Rugby Salitre.jpg" alt="">
            <div class="card__content">
              <h3>
                Estadio de Rugby Salitre
              </h3>
              <p>
                Es de los principales escenarios para la práctica del rugby en Bogotá.
              </p>
            </div>
            <div class="card__info">
              <div>
          ...
          <div class="card" id="card8">
            <img class="card__image" src="../php/Imagen_guardar/Estadio de Bonanza.jpg" alt="">
            <div class="card__content">
              <h3>
                Estadio de Bonanza
              </h3>
              <p>
                Este estadio cuenta con certificado FIFA y Rugby profesional
              </p>
